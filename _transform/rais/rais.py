...
class RaisTransform(object):
    ...
    def __init__(self, ano):
        ...
        self.variaveis = {
    u'Causa_Afastamento_1':{10:'Acidente de trabalho',20:'Acidente de trabalho Trajeto',30:'Doença relacionada ao trabalho',40:'Doença não relacionada ao trabalho',50:'Licensa Maternidade',60:'Servico Militar',70:'Licenca sem vencimento',99:'Sem Afastamentos',-1:'Ignorado'},
    u'Causa_Afastamento_2':{10:'Acidente de trabalho',20:'Acidente de trabalho Trajeto',30:'Doença relacionada ao trabalho',40:'Doença não relacionada ao trabalho',50:'Licensa Maternidade',60:'Servico Militar',70:'Licenca sem vencimento',99:'Sem Afastamentos',-1:'Ignorado'},
    u'Causa_Afastamento_3':{10:'Acidente de trabalho',20:'Acidente de trabalho Trajeto',30:'Doença relacionada ao trabalho',40:'Doença não relacionada ao trabalho',50:'Licensa Maternidade',60:'Servico Militar',70:'Licenca sem vencimento',99:'Sem Afastamentos',-1:'Ignorado'},
    u'Vínculo_Ativo_31/12':{0:'Não', 1:'Sim'},
    u'Faixa_Etária':{1:'10 A 14 anos',2:'15 A 17 anos',3:'18 A 24 anos',4:'25 A 29 anos',5:'30 A 39 anos',6:'40 A 49 anos',7:'50 A 64 anos',8:'65 anos ou mais'},
    u'Faixa_Hora_Contrat':{1: 'Até 12 horas',2: '13 a 15 horas',3: '16 a 20 horas',4: '21 a 30 horas',5: '31 a 40 horas',6: '41 a 44 horas'},
    u'Faixa_Remun_Dezem_(SM)':{0:'Até 0,50 salários mínimos',1:'Até 0,50 salários mínimos',2:'0,51 a 1,00 salários mínimos',3:'1,01 a 1,50 salários mínimos',4:'1,51 a 2,00 salários mínimos',5:'2,01 a 3,00 salários mínimos',6:'3,01 a 4,00 salários mínimos',7:'4,01 a 5,00 salários mínimos',8:'5,01 a 7,00 salários mínimos',9:'7,01 a 10,00 salários mínimos',10:'10,01 a 15,00 salários mínimos',11:'15,01 a 20,00 salários mínimos',12:'Mais de 20,00 salários mínimos'},
    ...
    u'Escolaridade_após_2005':{1: u'Analfabeto', 2: u'Até o 5 ano incompleto do ensino fundamental', 3: u'5 ano completo do ensino fundamental', 4: u'Do 6 ao 9 ano incompleto do ensino fundamental', 5: u'Ensino fundamental completo', 6: u'Ensino médio incompleto', 7: u'Ensino médio completo', 8: u'Educacão superior incompleta', 9: u'Educacão superior completa', 10: u'Mestrado completo', 11: u'Doutorado completo', -1: u'Ignorado'},
    ...
    def resolve_dicionario(self, df):
        ...
        df['ID'] = [self.f + '_' + str(i + 1) for i in range(df.index.size)]
