...
all_links = {
    ...
    # '2011': '',
    # '2012': '',
    '2013': 'http://_download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2013.zip',
    '2014': 'http://_download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2014.zip',
    '2015': 'http://_download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2015.zip',
    '2016': 'http://_download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2016_versao_28052018.zip'
}


def download_enade(ano):
    dir_destino = '/var/tmp/enade/' + str(ano) + '/_download/'
    mbyte = 1024 * 1024
    ano_str = str(ano)
